...
export class BankingService {
  ...
  public getapprovalstatus(e: number): Observable<Number> {
    return this.http.get<Number>(
      'http://localhost:8085/accountstatus' + '/' + e
    );
  }

  public deleteCust(e: Approval) {
    return this.http.delete(this.openAccountUrl + '/' + e.customerId);
  }

  public approveCust(e: Approval) {
    return this.http.put(this.openAccountUrl + '/' + e.customerId, e);
  }

  public getApprovalList(): Observable<Approval[]> {
    return this.http.get<Approval[]>(this.openAccountUrl);
  }
